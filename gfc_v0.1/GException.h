...
/**
 * @file GException.hpp
 * Exceptions for all of GFC, including location information
...
namespace gfc
{
      ...
      /**
       * @defgroup exceptiongroup GException Classes
       ...
       * than what std::exception provides.  Use GFC_THROW()
       * and GFC_RETHROW() to throw or rethrow these exceptions
   ...
   public:
      ...
      { errorId = errId; return *this; };
          ...
          * thrown or rethrown. An array of GExceptionLocation objects
      ...
      GException& addLocation(const GExceptionLocation& location)
         ...
         /**
          * Returns the GExceptionLocation object at the specified index. 
 ...
 * an gfc::GException derived class.  Use this to make specific exceptions,
